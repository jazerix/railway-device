...
#include "characteristics/samples.h"
...
static const struct ble_gatt_svc_def gat_svcs[] = {
         ...
         {0}}},
    {
        ...
        .characteristics = (struct ble_gatt_chr_def[]){
            ...
            {
            .uuid = BLE_UUID128_DECLARE(0xee, 0xdd, 0xfa, 0xd1, 0xaf, 0x51, 0x4e, 0xc6, 0x8a, 0x7b, 0xc0, 0x1e, 0x66, 0x42, 0x71, 0xd7),
            .flags = BLE_GATT_CHR_F_READ,
            .access_cb = bt_samples_handler
            },
            {0}
        }
    },
